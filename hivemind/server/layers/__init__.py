...
name_to_input = {'ffn': lambda batch_size, hid_dim: torch.empty((batch_size, hid_dim)),
                 ...
                 'gpt_initial_128tokens': lambda batch_size, hid_dim: torch.randint(0, 10, size=(batch_size, 128)),
                 'gpt_intermediate_128tokens': lambda batch_size, hid_dim: torch.randn(batch_size, 128, hid_dim),
                 'gpt_final_128tokens': lambda batch_size, hid_dim: (
